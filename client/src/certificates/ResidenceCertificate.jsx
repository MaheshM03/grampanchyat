    ...
    <div style={{ minHeight: "100vh", backgroundColor: "#f3f4f6" }}>
      ...
      >
        ...
        >
          <h2 style={{ fontSize: "20px", fontWeight: "600", marginBottom: "12px" }}>
            ग्रामपंचायत पोर्टलवरून रहिवास प्रमाणपत्र मिळवा
          </h2>
          ...
          >
            खालील प्रमाणपत्र मिळवण्यासाठी क्लिक करा रहिवास प्रमाणपत्रासाठी अर्ज
      ...
      >
        ...
        >
          ...
          <Link to="/residence-apply" style={{ textDecoration: "none" }}>
            <button
              style={{
                backgroundColor: "#facc15",
                color: "#1f2937",
